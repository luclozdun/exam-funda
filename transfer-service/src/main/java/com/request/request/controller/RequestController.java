...
public class RequestController {
    ...
    @GetMapping
    private ResponseEntity<List<RequestResponse>> getAll() {
    ...
    @PutMapping("/{id}")
    private ResponseEntity<RequestResponse> getById(@RequestBody RequestRequest request, @PathVariable("id") Long id) {
